...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .top-bar {
    ...
    border-bottom: none; padding: 0 32px; height: 64px;
    display: flex; align-items: center; justify-content: space-between; z-index: 50;
    box-shadow: 0 1px 0 var(--border-strong);
  }
  .top-bar-title { font-size: 19px; font-weight: 800; letter-spacing: -0.5px; }

  /* ── Search Box with Autocomplete ── */
  .search-wrapper { position: relative; width: 400px; }
  .search-box {
    display: flex; align-items: center; gap: 8px; background: #F2F4F6;
    border: 1.5px solid transparent; border-radius: 12px; padding: 10px 16px;
    width: 100%; transition: all 0.2s ease;
  }
  .search-box:focus-within { border-color: var(--accent-blue); box-shadow: 0 0 0 3px rgba(49,130,246,0.1); background: white; }
  ...
  .search-dropdown {
    ...
    box-shadow: 0 8px 40px rgba(0,0,0,0.12); overflow: hidden; z-index: 200;
  ...
  .index-card { flex: 1 1 0; min-width: 200px; background: var(--bg-card); border: none; border-radius: var(--radius-md); padding: 20px 24px; cursor: pointer; transition: all 0.2s ease; box-shadow: var(--shadow-card); }
  ...
  .card { background: var(--bg-card); border: none; border-radius: var(--radius-lg); padding: 24px; margin-bottom: 16px; box-shadow: var(--shadow-card); transition: box-shadow 0.2s ease; }
  .card:hover { box-shadow: var(--shadow-md); }
  .card-title { font-size: 17px; font-weight: 800; margin-bottom: 4px; display: flex; align-items: center; gap: 8px; letter-spacing: -0.3px; }
  .card-description { font-size: 13px; color: var(--text-tertiary); margin-bottom: 20px; }

  .company-hero { background: var(--bg-card); border: none; border-radius: var(--radius-xl); padding: 32px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: flex-start; gap: 32px; box-shadow: var(--shadow-card); }
  .company-info h2 { font-size: 26px; font-weight: 800; letter-spacing: -0.6px; margin-bottom: 4px; }
  .company-ticker { font-size: 14px; color: var(--text-tertiary); font-weight: 500; margin-bottom: 10px; }
  .company-desc { font-size: 13px; color: var(--text-secondary); line-height: 1.7; max-width: 520px; }
  .price-block { text-align: right; min-width: 200px; }
  .price-current { font-size: 34px; font-weight: 800; letter-spacing: -0.8px; }
  ...
  .tab-group { display: flex; gap: 6px; background: #ECEEF0; border-radius: var(--radius-sm); padding: 4px; margin-bottom: 20px; width: fit-content; }
  .tab-btn { padding: 8px 18px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; border: none; background: transparent; color: var(--text-tertiary); transition: all 0.2s ease; font-family: inherit; }
  .tab-btn.active { background: var(--bg-card); color: var(--text-primary); font-weight: 700; box-shadow: var(--shadow-sm); }
  .tab-btn:hover:not(.active) { color: var(--text-secondary); }

  .toggle-group { display: flex; gap: 0; border: none; border-radius: var(--radius-sm); overflow: hidden; width: fit-content; background: #ECEEF0; padding: 3px; }
  .toggle-btn { padding: 7px 14px; font-size: 12px; font-weight: 600; cursor: pointer; border: none; background: transparent; color: var(--text-tertiary); transition: all 0.15s ease; font-family: inherit; border-radius: 7px; border-right: none; }
  ...
  .news-card { background: var(--bg-card); border: none; border-radius: var(--radius-md); overflow: hidden; cursor: pointer; transition: all 0.2s ease; box-shadow: var(--shadow-card); }
  ...
  .econ-card { background: var(--bg-card); border: none; border-radius: var(--radius-md); padding: 18px 20px; transition: box-shadow 0.2s ease; box-shadow: var(--shadow-card); }
  .econ-card:hover { box-shadow: var(--shadow-md); }
  ...
  .sentiment-card { background: var(--bg-card); border: none; border-radius: var(--radius-lg); padding: 28px; text-align: center; box-shadow: var(--shadow-card); }
  ...
  .inline-chart-panel { background: var(--bg-card); border: none; border-radius: var(--radius-lg); margin-top: 12px; margin-bottom: 8px; overflow: hidden; animation: expandDown 0.35s cubic-bezier(0.16, 1, 0.3, 1) forwards; box-shadow: var(--shadow-card); }
  ...
  .paywall-card {
    background: white; border-radius: 24px; padding: 40px 36px; max-width: 400px; width: 90%;
    box-shadow: 0 24px 80px rgba(0,0,0,0.18); text-align: center;
  }
  .paywall-card h3 { font-size: 22px; font-weight: 800; margin-bottom: 8px; letter-spacing: -0.5px; }
